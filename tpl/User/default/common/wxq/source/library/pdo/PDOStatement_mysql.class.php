 ...
 * @Date		2005/10/13
 * @LastModified	2006/01/29 09:30 [fixed exe_cute bug]
 * @Version		0.1b - tested
 */
class PDOStatement_mysql {
	...
	/**
	 * Public method:
	 *	Replace ? or :named values to exe_cute prepared query
	...
	/**
	 * Public method:
	 *	Returns, if present, next row of exe_cuted query or false.
         ...
         * @Param	Integer		this variable is not used but respects PDO original accepted parameters
         * @Param	Integer		this variable is not used but respects PDO original accepted parameters
         * @Return	Mixed		Next row of exe_cuted query or false if there is nomore.
	 */
	...
	/**
	 * Public method:
	 *	Returns an array with all rows of exe_cuted query.
	...
	/**
	 * Public method:
	 *	Returns, if present, first column of next row of exe_cuted query
	 ...
	 *	Sets default fetch mode to use with this->fetch() method.
         ...
         * @Param	Integer		PDO_FETCH_* constant to use while reading an exe_cute query with fetch() method.
