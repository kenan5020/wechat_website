...
class BCS_RequestCore {
	...
	/**
	 * Register a callback function to exe_cute whenever a data stream is read from using
	 ...
	 * <li>The name of a global function to exe_cute, passed as a string.</li>
	 * <li>A method to exe_cute, passed as <code>array('ClassName', 'MethodName')</code>.</li>
	...
	/**
	 * Register a callback function to exe_cute whenever a data stream is written to using
	 ...
	 * parameters.
	 *
	 * @param resource $curl_handle (Optional) The reference to the already exe_cuted cURL request.
