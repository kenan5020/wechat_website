...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName) {
	...
	$("#windown-box").show();
	if( height >= 527 ) {
		$("#windown-title").css({width:(parseInt(width)+122)+"px"});
		$("#windown-content").css({width:(parseInt(width)+117)+"px",height:height+"px"});
	}else {
		$("#windown-title").css({width:(parseInt(width)+110)+"px"});
		$("#windown-content").css({width:(parseInt(width)+100)+"px",height:height+"px"});
	}
