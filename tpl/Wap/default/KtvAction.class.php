...
class KtvAction extends BaseAction{
	...
	public function sms(){
		...
		$this->ktv_order=M('yuyue_order');
		$orders=$this->ktv_order->where(array('token'=>$this->token,'type'=>$this->type))->order('date desc')->limit(0,1)->find();
