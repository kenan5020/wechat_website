...
class JiubaAction extends BaseAction{
	...
	public function sms(){
		...
		$this->jiuba_order=M('yuyue_order');
		$orders=$this->jiuba_order->where(array('token'=>$this->token,'type'=>$this->type))->order('date desc')->limit(0,1)->find();
