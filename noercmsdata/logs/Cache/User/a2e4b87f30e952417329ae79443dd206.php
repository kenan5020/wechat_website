            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" required="" name="weixin" value="<?php echo ($info["weixin"]); ?>" class="px" tabindex="1" size="25">　比如：cqaboy </td>
                </tr>
				 <tr>
                  <th>AppID：</th>
                  <td><input type="text" name="appid" value="<?php echo ($info["appid"]); ?>" class="px" size="25">　高级认证服务号特权功能，微客服、粉丝管理等系统，可以不填 </td>
                </tr>
				<tr>
                  <th>AppSecret：</th>
                  <td><input type="text" name="appsecret" value="<?php echo ($info["appsecret"]); ?>" class="px"  size="25">高级认证服务号特权功能，微客服、粉丝管理等系统，可以不填 </td>
                </tr>
				<tr>
               ...
               （此处关联公交等本地化查询）
                ...
                <tr>
                  ...
                  <td><input value="img/images/email-help.jpg"  onchange="document.getElementById('end').src=this.value;"  style="width:0px;" id="pic2">请使用163邮箱，需要开启IMAP/SMTP服务，<a href="###" onclick="viewImg('pic2')">开启帮助点我</a><script src="/tpl/static/upyun.js"></script><span class="red">■■■■■■■■■■■■■■■■■</span></td>
                </tr>   
                 <tr>
                  <th><span class="red">*</span>邮件地址：</th>
                  <td><input type="text" required="" name="email" value="<?php echo ($info["email"]); ?>" class="px" tabindex="1" size="25"> <span class="red">请一定填写163邮箱地址</span> 比如：xxxxxx@163.com</td>
                </tr>    
				                 <tr>
                  <th><span class="red">*</span>SMTP账号：</th>
                  <td><input type="text" required="" name="emailuser" value="<?php echo ($info["emailuser"]); ?>" class="px" tabindex="1" size="25"> <span class="red">请填写您的163账号, 比如：xxxxxx</span></td>
                </tr>  
				                 <tr>
