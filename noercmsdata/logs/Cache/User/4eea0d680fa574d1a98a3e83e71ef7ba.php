...
<div class="content"  >
          <div class="cLineB"><h4>邮件平台</h4>请使用163邮箱，需要开启IMAP/SMTP服务，<a href="/img/images/email-help.jpg" target="_blank">开启帮助点我</a></div>
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                ...
                <tr>
                  ...
                  <span class="red">请填写您的163账号, 比如：xxxxxx</span>
                  </td>
                </tr>
				<tr>
                  ...
                  <span class="red">请填写您的163邮箱密码</span>请放心填写，此密码只有您自己看见</span>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>邮件平台状态：</th>
                  <td><input type="radio" value="1" name="emailstatus" <?php if($info['emailstatus'] == '1'): ?>checked="checked"<?php endif; ?> />开启 <input type="radio" value="0" <?php if($info['emailstatus'] == '0'): ?>checked="checked"<?php endif; ?> name="emailstatus"/>关闭
                  </td>
                </tr>
				<div>
