...
<link rel="stylesheet" type="text/css" href="/tpl/static/artDialog/skins/default.css" />
...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="img" id="img" style="width:500px" >  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('img','icon')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a></TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
...
<TR>
  ...
  <TD>
	...
	<a href="###" class="a_upload" onclick="chooseTpl('tpid','selecttpl',1)">选择模板</a>
	<a href="###" class="a_upload" onclick="viewTpl()">预览</a>
	<script src="/tpl/static/upyun.js"></script><script>
		function viewTpl(){
			var tid = $('#tpid').val();
			chooseTpl(tid,'',2);
		}
...
<tr>
  ...
  <TD>
	...
	<a href="###" class="a_upload" onclick="chooseTpl('conttpid','selectconttpl',3)">选择模板</a>
	<a href="###" class="a_upload" onclick="viewTpl2()">预览</a>
