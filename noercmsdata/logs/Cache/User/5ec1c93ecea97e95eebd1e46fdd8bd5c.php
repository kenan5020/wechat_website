...
<div class="tab">
<ul>
<li class="current tabli" id="tab2"><a href="<?php echo U('Forum/index',array('token'=>$token));?>">帖子管理</a></li>
<li class="tabli" id="tab0"><a href="<?php echo U('Forum/comment',array('token'=>$token));?>">评论管理</a></li>

<li class="tabli" id="tab2"><a href="<?php echo U('Forum/message',array('token'=>$token));?>">消息管理</a></li>
<li class="tabli" id="tab5"><a href="<?php echo U('Forum/config',array('token'=>$token,'infotype'=>'Shop'));?>">社区配置</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
