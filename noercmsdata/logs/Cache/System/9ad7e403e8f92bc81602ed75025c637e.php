...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="alipay_name" value="<?php echo C('alipay_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：zhangjcqy@163.com</span>
	  </td>
    </tr>
	 <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform1" action="<?php echo U('Site/tenpay');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="partner" value="<?php echo C('partner');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：327979560</span>
	  </td>
    </tr>
	 <tr> 
