...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 noercms微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 noercms微信公共平台，还是部份栏目使用 微信公共平台，在你使用了 noercms微信公共平台的网站主页上必须加上 noercms微信公共平台  官方网址(<a href="http://weixin.maozi168.cn" target="_blank">weixin.maozi168.cn</a>)的链接。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
                ...
                <p align=right>BY noercms微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' noercms微信公共平台V'.SOFT_VERSION.' 安装程序',
...
$dirfile_items = array(
    'conf' => array('type' => 'file', 'path' => './noercmsdata/Conf/db.php'),
    'conf' => array('type' => 'file', 'path' => './noercmsdata/Conf/info.php'),
    'conf' => array('type' => 'file', 'path' => './noercmsdata/Conf/System/config.php'),
);
...
if (file_exists('lock')){
	@header("Content-type: text/html; charset=UTF-8");
	echo '系统已经安装过了，如果要重新安装，那么请删除install目录下的lock文件.访问<a href="http://weixin.maozi168.cn" target="_blank">weixin.maozi168.cn</a>获取更多帮助';
	exit;
}
...
(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			//新增一个标识文件，用来屏蔽重新安装
			$_config = '../noercmsdata/Conf/System/config.php';
			...
			$_infoconfig = '../noercmsdata/Conf/info.php';
...
<meta content="noercms微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by noercms微信公共平台(c) v1.0 2014-2015</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function config_edit() {
	...
	$config = '../noercmsdata/Conf/db.php';
